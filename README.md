...
Flash the Firmware found in the [Quntis Sniffer](https://github.com/bluemaex/Reverse-Engineer-a-Quntis-Monitor-LED-Bar-Controller/tree/main/Code/Quntis%20Sniffer) and run it. Then press your remote a few times to (hopefully) see the adress of your Remote printed. With this Adress you can now update the Remote Address in `QuntisControl.h` of the ported code and you should be able to control your Quintis Desk Lamp with MQTT/HomeAssistant!

The new ESP32 you can find next to the Arduino Version: https://github.com/bluemaex/Reverse-Engineer-a-Quntis-Monitor-LED-Bar-Controller/blob/main/Code/Quntis%20ESP32_MQTT
...
Please definitely read the original README to understand a bit more, especially the part where you need to patch the [RF24 library](#controller-using-rfnano-nrf24l01).

# Original README from Lexy1972 - Highly recommend to read,
